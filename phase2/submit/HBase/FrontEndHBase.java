...
public class FrontEndHBase extends Verticle {
	...
	private ConcurrentHashMap<String, String> hashCache;
	private Pattern newlinePattern;
	
	@Override
	public void start() {
		hashCache = new ConcurrentHashMap<String, String>();
	...
	public String handleRequestQ3(String userid, 
			...
			Result getResult = talkToHBase.getResultFromHBaseQ3(userid);
			if(getResult == null || getResult.isEmpty()) {
				return "";
			}
			
			String responseStringPos = new String(getResult.
					getValue(Bytes.toBytes("data"), Bytes.toBytes("positive")), StandardCharsets.UTF_8);
			String responseStringNeg = new String(getResult.
					getValue(Bytes.toBytes("data"), Bytes.toBytes("negative")), StandardCharsets.UTF_8);
			...
			String responseString = teamInfo + "Positive Tweets\n" + responseStringPos + 
					"\nNegative Tweets\n" + responseStringNeg;
			return  responseString;
		//}
	}
